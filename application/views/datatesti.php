                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
											$x=1;
											foreach($testi as $ambil){
                                        ?>
                                            <tr>
                                                <td><?php echo $x;?></td>
                                                <td><?php echo $ambil->no_order?></td>
                                                <td><?php echo $ambil->nama?></td>
                                                <td><?php echo $ambil->isi?></td>
                                                <td><?php echo $ambil->penilaian?></td>
		...
		?>
			    ...
			    <div class="modal-dialog">
			        <div class="modal-content">
			            ...
			            <form class="form-horizontal" action="<?php echo base_url('index.php/ctrladmintesti/ubahstatus')?>" method="post" enctype="multipart/form-data" role="form">
				            <div class="modal-body">
				                    <div class="form-group">
				                        ...
				                        <div class="col-lg-12">
				                        	...
				                        	<input type="text" class="form-control" readonly id="jenjang" name="nama" placeholder="Nama" value="<?php echo $ambil->nama?>">
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">No Order</label>
				                        <div class="col-lg-12">
				                            <input type="text" class="form-control" id="nama" readonly name="noorder" placeholder="Username" value="<?php echo $ambil->no_order?>">
				                        </div>
                                    </div>
                                    <div class="form-group">
				                        ...
				                        <div class="col-lg-12">
                                            <select name="status" class="form-control">
                                                <option value="1">1 - Sembunyikan</option>
                                                <option value="2">2 - Tampilkan</option>
                                            </select>    
                                        </div>
                                    </div>
				                </div>
