...
<div class="banner py-8" id="home">
	<div class="layer">
		<div class="container py-md-12">
			...
			<h2 class="heading text-center mb-sm-5 mb-4">Upload Kwitansi</h2>
				<div class="row">
					<div class="col-lg-12 p-0">
					<div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div>
						<form role="Insertform" action="<?php echo base_url('index.php/ctrlkwitansi/insertdata')?>" enctype="multipart/form-data" method="post">
                            <div class="row">
									<div class="col-md-12">
										<input type="text" placeholder="no_order" name="no_order" class="form-control">
									</div>
							</div>
							<br>
							<div class="row">
