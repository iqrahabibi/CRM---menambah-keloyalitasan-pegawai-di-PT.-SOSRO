...
<div class="banner py-8" id="home">
	<div class="layer">
		<div class="container py-md-12">
			...
			<h2 class="heading text-center mb-sm-5 mb-4">Kritik Dan Saran </h2>
				<div class="row">
					<div class="col-lg-12 p-0">
					<div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div>
						<form role="Insertform" action="<?php echo base_url('index.php/kritik/sendmail')?>" enctype="multipart/form-data" method="post">
							<div class="row">
							...
							<div class="row">
									<div class="col-md-12">
										<textarea name="kritik" required placeholder="Kritik dan Saran" class ="form-control"></textarea>
								</div>
							</div>
							<br>
							<div class="row">
