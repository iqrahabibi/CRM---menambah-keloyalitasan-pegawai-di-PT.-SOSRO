                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
											$x=1;
											foreach($promo as $ambil){
                                        ?>
                                            <tr>
                                                <td><?php echo $x;?></td>
                                                <td><?php echo $ambil->judul?></td>
                                                <td><?php echo $ambil->isi?></td>
                                                <td><?php echo $ambil->tgl_input?></td>
                                                <td><?php echo $ambil->kode_promo?></td>
                                                <td width="20px;"><a href="#edit-data<?php echo $ambil->id?>" data-toggle="modal" class="btn btn-warning" >Edit</a></td>
												<td width="20px;"><a href="<?php echo base_url('index.php/ctrlpromo/deletedata/'.$ambil->id.'')?>" class="btn btn-danger" >Hapus</a></td>
                                            </tr>
                                        <?php 
                                            $x++;    
                                            }
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data<?php echo $ambil->id?>" width="75%" class="modal fade">
			    <div class="modal-dialog">
			        <div class="modal-content">
			            ...
			            <form class="form-horizontal" action="<?php echo base_url('index.php/ctrlpromo/editdata')?>" method="post" enctype="multipart/form-data" role="form">
				            <div class="modal-body">
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Kode Promo</label>
				                        <div class="col-lg-12">
                                            <input type="hidden" class="form-control" id="jenjang" name="id" value="<?php echo $ambil->id?>" placeholder="Kode Promo">  
				                        	<input type="text" class="form-control" id="jenjang" value="<?php echo $ambil->kode_promo?>" name="kd_promo" placeholder="Kode Promo">
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Judul</label>
				                        <div class="col-lg-12">
				                            <input type="text" value="<?php echo $ambil->judul?>" class="form-control" id="nama" name="judul">
				                        </div>
                                    </div>
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Isi</label>
				                        <div class="col-lg-12">
                                            <textarea class="form-control" name="isi" placeholder="Isi"><?php echo $ambil->isi?></textarea>
				                        </div>
                                    </div>
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Tanggal Input</label>
				                        <div class="col-lg-12">
                                            <input type="date" value="<?php echo $ambil->tgl_input?>" class="form-control" name="tgl" placeholder="Isi">
				                        </div>
                                    </div>
				                </div>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="insert-data" width="75%" class="modal fade">
			    <div class="modal-dialog">
			        <div class="modal-content">
			            ...
			            <form class="form-horizontal" action="<?php echo base_url('index.php/promo/send')?>" method="post" enctype="multipart/form-data" role="form">
				            <div class="modal-body">
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Kode Promo</label>
				                        <div class="col-lg-12">
				                        	<input type="text" class="form-control" id="jenjang" name="kd_promo" placeholder="Kode Promo">
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Judul</label>
                                    ...
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Isi</label>
				                        <div class="col-lg-12">
                                            <textarea class="form-control" name="isi" placeholder="Isi"></textarea>
				                        </div>
                                    </div>
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Tanggal Input</label>
				                        <div class="col-lg-12">
                                            <input type="date" class="form-control" name="tgl" placeholder="Isi">
				                        </div>
                                    </div>
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Lampiran</label>
				                        <div class="col-lg-12">
				                            <input type="file" id="nama" name="resume">
				                        </div>
                                    </div>
