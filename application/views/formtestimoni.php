...
<div class="banner py-8" id="home">
	<div class="layer">
		<div class="container py-md-12">
			...
			<h2 class="heading text-center mb-sm-5 mb-4">Testimoni</h2>
				<div class="row">
					<div class="col-lg-12 p-0">
					<div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div>
						<form role="Insertform" action="<?php echo base_url('index.php/ctrltesti/simpan')?>" enctype="multipart/form-data" method="post">
							<div class="row">
							...
							<div class="row">
									<div class="col-md-12">
										<input type="text" class="form-control" required placeholder="No Order" name="no_order">
									</div>
							...
							<div class="row">
									<div class="col-md-12">
										<textarea name="isi" required placeholder="Isi" class ="form-control"></textarea>
								</div>
							</div>
							<br>
							<div class="row">
									<div class="col-md-12">
                                        <select name="nilai" class="form-control">
                                            <option value="1 - Kurang">1 - Kurang</option>
                                            <option value="2 - Cukup">2 - Cukup</option>
                                            <option value="3 - Baik">3 - Baik</option>
                                            <option value="4 - Puas">4 - Puas</option>
                                            <option value="5 - Sangat Puas">5 - Sangat Puas</option>
                                        </select>
									</div>
