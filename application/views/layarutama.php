	...
	<div class="container">
		...
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
				<li class=""><a href="<?php echo base_url('index.php/ctrllayarutama')?>">Home</a></li>
				<li class="active"><a href="<?php echo base_url('index.php/ctrllayarutamapromosi')?>">Promosi</a></li>
			</ul>
