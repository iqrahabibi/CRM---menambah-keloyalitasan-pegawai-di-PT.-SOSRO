	...
	<div class="container">
		...
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
				<li class="active"><a href="<?php echo base_url('index.php/ctrllayarutama')?>">Home</a></li>
				<li class=""><a href="<?php echo base_url('index.php/ctrllayarutamapromosi')?>">Promosi</a></li>
			</ul>
			<div class="login-icon ml-2">
				<a class="user" href="<?php echo base_url('index.php/ctrllogin')?>">Login</a>
			</div>
	...
	<div class="container py-md-5 py-3">
		...
		<?php foreach($kritik as $promo){?>
			...
			<div class="col-lg-5 mb-lg-5 mb-4">
				<h5><?php echo date("d-m-Y", strtotime($promo->tgl_input))?></h5>
